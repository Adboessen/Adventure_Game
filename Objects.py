...
LordofWolves = {'name' : 'Lord of Wolves','damage' : 19, 'ammo' : 4, 'price' :500, 'ammoPrice' : 50, 'magSize' : 4, 'owned' : False}
Recluse = {'name' : 'Recluse','damage' : 7, 'ammo' : 35, 'price' :800, 'ammoPrice' : 3, 'magSize' : 35, 'owned' : False}
weaponList = [AceofSpades, BadJuju, HardLight, Revoker, LordofWolves, Recluse]
    

helmet = {'name' : 'Helemt', 'hpAdded' : 10, 'price' : 100, 'owned' : False}
chestPlate = {'name' : 'Chest Plate', 'hpAdded' : 15, 'price' :200, 'owned' : False}
gauntlets = {'name' : 'Gauntlets', 'hpAdded' : 10, 'price' :120, 'owned' : False}
boots = {'name' : 'Boots', 'hpAdded' : 5, 'price' :50, 'owned' : False}
armourList = [helmet, chestPlate, gauntlets, boots]
    
goldenGun = {'name' : 'Golden Gun', 'damage' : 20, 'strength' : 5}
